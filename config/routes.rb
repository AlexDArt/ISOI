Rails.application.routes.draw do
  ...
  resources :transformer_substations do
    collection do 
      post :import
      get :search
    end
  end
  resources :boiler_houses do
    collection do 
      post :import
      get :search
    end
  end
  resources :managment_companies do
    collection do 
      post :import
      get :search
    end
  end
  resources :water_intake_units do
    collection do 
      post :import
      get :search
    end
